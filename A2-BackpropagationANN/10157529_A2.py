...
# determine desired outputs
    ...
    for number in range(0, len(input_data)):
        desired_output_number = input_data[number].pop()
        desired_output_numbers.append(int(desired_output_number))
